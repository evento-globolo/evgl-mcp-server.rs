...
- Visibility: public
- Initial repository commit: `81159c12eade2e8db7cad9c00b12945d913f41d3`
- Original recovery-review base: `6e69697b525ce696f98a8e74b35c888487240796`
- Shared-graph main head used for the semantic rebase: `81f1a7f346a6bfbb5e1bac35f0f95534e6eb3c6b`
- Review branch: `agent/den-2290-recovery-review`
- Review pull request: `evento-globolo/evgl-mcp-server.rs#1`
- Canonical bootstrap issue: DEN-2290
...
`evento-globolo/evgl-e2e` returned HTTP 404 during the 2026-08-08 reconciliation. Its repository creation remains a separate create-only queue item; this repository must not be renamed or repurposed as the E2E surface.
