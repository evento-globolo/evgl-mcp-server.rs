# AGENTS.md — evento-globolo/evgl-mcp-server.rs
...
- GitHub org: [`evento-globolo`](https://github.com/evento-globolo)
- Repository: [`evento-globolo/evgl-mcp-server.rs`](https://github.com/evento-globolo/evgl-mcp-server.rs)
- Local checkout: `~/codes/evento-globolo/evgl-mcp-server.rs`
...
- Sibling test org: `github.com/evento-globolo-test` (external/e2e coverage and extra GHA minutes)
- Slack workspace: oresoftware-workspace.slack.com
- Kind: product MCP server for this GitHub org
- Package / service name: `evgl-mcp-server`
